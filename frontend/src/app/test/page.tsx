        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">HTML Diff Tester</h1>
                <p className="text-sm text-muted">Teste die Änderungserkennung mit eigenen HTML-Inhalten</p>
              </div>
            </div>
          </div>
        </div>
